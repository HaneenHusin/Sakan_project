...
export default function LargeWithNewsletter() {
    return (
        <Box
            bg={'brand.footer_gray'}
            w={ "full" }
            h={{base:'150px',md:'200px'}}
            color={useColorModeValue('gray.700', 'gray.200')}>
            <Container w={'full'} pt={'15px'} >
                <SimpleGrid  spacing={6}
                    templateColumns={ '2fr 1fr 1fr 1fr' }>
                    <Stack spacing={2}>
                        <Heading fontSize={{base:'md',md:'xl'}} textColor={'brand.blue'}>
                            {trans('follow_us')}
                        </Heading>
                        <Stack w={{base:'50',sm:'100',md:'100px'}} pt={'3px'} direction={'row'} spacing={6}>
                    ...
                    <Stack  w={{base:'100',sm:'150',md:'200px'}} align={'flex-start'} spacing={3}>
                        <Heading fontSize={{base:'md',md:'xl'}} textColor={'brand.blue'}>
                            {trans('contact_us')}
                        </Heading>
                        <Text fontSize={{base:'sm',md:'xl'}}>+96999999999</Text>
                        <Text fontSize={{base:'sm',md:'xl'}}>hhh@gmail.com</Text>
                        <Text fontSize={{base:'sm',md:'xl'}}>4582147</Text>

                    </Stack>
                    <Stack  w={{base:'100px',sm:'150',md:'200px'}}  spacing={3}>
                        <Heading fontSize={{base:'md',md:'xl'}} textColor={'brand.blue'}>
                            {trans('access_link')}
                        </Heading>
                        <Link fontSize={{base:'sm',md:'xl'}} href={'#'}>{trans('privacy_police')}</Link>
                        <Link fontSize={{base:'sm',md:'xl'}} href={'#'}>{trans('payment_method')}</Link>

                    </Stack>
                    <Stack w={{base:'1000px',sm:'150',md:'200px'}} align={'flex-start'}>
                        <Heading fontSize={{base:'md',md:'xl'}} textColor={'brand.blue'}>
                            {trans('about_us')}
                        </Heading>
                        <Box>
